...
if __name__ == "__main__":
    ...
    cifar10_test.data = cifar10_test.data[:128]
    cifar10_test.targets = cifar10_test.targets[:128]
    ...
    for sample_image, y_val in cifar10_test_loader:
        ...
        for _ in tqdm(range(20), colour='red'):
            ...
            for _ in range(10):
                ...
                eot += grad
                delta.grad.zero_()
            grad_norms = torch.norm(eot.view(1, -1), p=2, dim=1) + eps_for_division  # nopep8
            eot = eot / grad_norms.view(1, 1, 1, 1) 
